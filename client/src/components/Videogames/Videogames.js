...
function Home(props) {
//Aqui declaro todos los estados inicales
  ...
  /// maneja la casilla de añadir --->>>>>>>>>>>>>>>>>>>>>>>pendiente

  const added = document.getElementById("added") != null
      ? document.getElementById("added").checked
      : false;

  //maneja la casilla de existente

  const existing = document.getElementById("existing") != null
  ...
  return (
    <div className="backg">
      ...
      <div className="row containerForms">
        ...
        >
          <input
            id="game1" type="text" value={filter} placeholder="Filter by genre" className="genreFilter" 
            onChange={(e) => handleChangeFilter(e)}
          />
          <input
            type="checkbox" name="added" id="added" value="added" className="added"
          />
          <label htmlFor="added">Added</label>
          <input
            type="checkbox" name="existing" id="existing" value="existing" className="existing"
          />
